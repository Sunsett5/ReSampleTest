...
class DDIMSampler(object):
    ...
    def resample_sampling(self, measurement, measurement_cond_fn, cond, shape, operator_fn=None,
        ...
        for i, step in enumerate(iterator):   
            ...
            out, pred_x0, _ = self.precise_tweedie(img, cond, measurement, ts, index, prev_index, ddim_use_original_steps, quantize_denoised, temperature, noise_dropout, 
    ...
    def precise_tweedie(self, x, c, measurement, t, original_index, original_prev_index, use_original_steps, quantize_denoised, temperature, noise_dropout, 
                        score_corrector, corrector_kwargs, unconditional_guidance_scale, unconditional_conditioning, repeat_noise=False, n_shots=1):
